...
int contador=0;
int masVieja=anio;
int masViejaTitulo= masVieja;

    if(contador==1)
            {
                masVieja=ePelicula.anio;
                masViejaTitulo=ePelicula.titulo;
...
int mostrarPeliculaMasVieja(ePelicula listaPelicula[], int len)
{
    ...
    for(i = 0; i < len; i++)
    {
        if(listaPelicula[i].isEmpty != LIBRE)
        {
            mostrarPeliculaMasVieja(listaPelicula, i);
        }
    }
}
*/
void peliculaMasVieja(ePelicula listaPelicula[], int len)
{
    ...
    if(flag == 0)
    {
        menor=listaPelicula.anio;

        flag=1;
    }
    else if(listaPelicula.anio <= menor)
    {
        menor=listaPelicula.anio;
...
void mostrarMasVieja(ePelicula listaPelicula[], int len)
{
    ...
    for(i = 0; i < len; i++)
    {
        if(listaPelicula[i].isEmpty != LIBRE)
        {
            peliculaMasVieja(listaPelicula, i);
        }
    }
}
